...
| Pytanie | Co wpisać |
|---------|-----------|
| **Log in to Claude CLI** | Wpisz `Y` — przeniesie Cię na użytkownika `claude`. Wpisz `claude`, przejdź logowanie w przeglądarce, wyjdź z Claude (`/exit` lub Ctrl+C), wciśnij 2× Ctrl+D, potem wpisz `exit` żeby wrócić do installera |
