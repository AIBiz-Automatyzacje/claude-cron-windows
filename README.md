...
| Pytanie | Co wpisać |
|---------|-----------|
| **Log in to Claude CLI** | Wpisz `Y` — przeniesie Cię na użytkownika `claude`. Wpisz `claude`, przejdź logowanie w przeglądarce, wyjdź z Claude (`/exit` lub Ctrl+C), potem wpisz `exit` żeby wrócić do installera |
